...
rm -f $OUT_FS_DATA_NAME
rm -f $OUT_FLASH_DATA_NAME
rm -f $OUT_FLASH_DATA_NAME_SREC
...
/c/git/rh850/tools/bin2rec/objcopy --srec-forceS3 --change-addresses $OLD_START_ADDRESS  -I binary -O srec $OUT_FLASH_DATA_NAME  $OUT_FLASH_DATA_NAME_SREC
